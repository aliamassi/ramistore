                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-2 text-sm text-gray-600 mt-1">
                            ...
                            <form method="POST" action="{{ route('cart.remove') }}" class="ajax-request"
                                ...
                                @if($line['qty'] > 1)
                                    <button class="px-2 py-0.5 border rounded-md hover:bg-gray-50 decrease-btn">-1
                                    </button>
                                @endif
                            </form>
                        ...
                        @if($type == 'variants')
                            ...
                            @foreach($line['sizes'] as $key => $val)


                            <div class="flex items-center gap-2 text-sm text-gray-600 mt-1">
                                <span class="qty">Size: {{ $key }}</span> <span class="qty">Qty: {{$val }}</span>
